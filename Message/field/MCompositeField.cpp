 ...
 * 构造函数
 */
MCompositeField::MCompositeField(U16 nTag, const string& sName, MField* pParent, U16 nVer)
    : MField(nTag, M_FIELD_TYPE_TLV, sName, pParent, nVer)
{
    //
}
 ...
 * 拷贝构造函数
 */
MCompositeField::MCompositeField(const MCompositeField& stField)
    : MField(stField)
{
    //
}
