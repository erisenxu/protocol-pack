...
{
    FIELD_TYPE_BYTE = 1,    // U8/S8，占1个字节
    FIELD_TYPE_SHORT = 2,   // U16/S16，占2个字节
    FIELD_TYPE_INT = 3,     // U32/S32，占4个字节
    FIELD_TYPE_LONG = 4,    // U64/S64，占8个字节
    FIELD_TYPE_STRING = 5,  // 字符串，特殊的TLV字段
    FIELD_TYPE_TLV = 6,     // Tag-Length-Value字段，长度由length决定。其中length占位4个字节，其长度不包含自己
    FIELD_TYPE_ARRAY = 7    // 数组
};
