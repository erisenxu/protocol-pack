...
<pre>00 01 04 12 34 </pre>

Tag为4，类型为string的字符串http://www.qq.com/xy.jpg，编码为二进制为：<p>
<pre>00 04 09 00 00 00 18 68 74 74 70  3a 2f 2f 77 77 77 2e 71 71 2e 63 6f 6d 2f 78 79  2e 6a 70 67</pre>
其中：<p>
<pre>
	00 04 为Tag
	09 为类型
...
<pre>00 02 0b 00 00 00 24 00 01 04 12 34 00 04 09 00 00 00 18 68 74 74 70  3a 2f 2f 77 77 77 2e 71 71 2e 63 6f 6d 2f 78 79  2e 6a 70 67</pre>
其中：<p>
<pre>
	00 02 为结构体Tag
	0b 为类型
